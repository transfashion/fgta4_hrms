...
if (is_file(__DIR__ .'/attsum.php-handler.php')) {
	require_once __DIR__ .'/attsum.php-handler.php';
}

/**
 * hrms/hrd/attsum/attsum.php
 *
 * ===================================================================
 * Entry point Program Module attsum
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\attsum_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new attsum_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
