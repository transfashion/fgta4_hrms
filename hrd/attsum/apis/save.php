...
$API = new class extends attsumBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->hratdsum_dt = (\DateTime::createFromFormat('d/m/Y',$obj->hratdsum_dt))->format('Y-m-d');
			...
			try {
				...
				$dataresponse = array_merge($record, [
					...
					'hratdsum_dt' => date("d/m/Y", strtotime($row['hratdsum_dt'])),
