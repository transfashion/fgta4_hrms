...
if (is_file(__DIR__ .'/hremplclr.php-handler.php')) {
	require_once __DIR__ .'/hremplclr.php-handler.php';
}

/**
 * hrms/hrd/hremplclr/hremplclr.php
 *
 * ===================================================================
 * Entry point Program Module hremplclr
 * ===================================================================
 ...
 * awal dibuat tanggal 05/02/2023
 * terakhir di generate tanggal 05/02/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hremplclr_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hremplclr_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
