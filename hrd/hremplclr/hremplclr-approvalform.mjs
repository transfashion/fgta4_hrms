...
const obj = {
	txt_hremplclrappr_id: $('#pnl_editapprovalform-txt_hremplclrappr_id'),
	chk_hremplclrappr_isapproved: $('#pnl_editapprovalform-chk_hremplclrappr_isapproved'),
	txt_hremplclrappr_by: $('#pnl_editapprovalform-txt_hremplclrappr_by'),
	txt_hremplclrappr_date: $('#pnl_editapprovalform-txt_hremplclrappr_date'),
	txt_hremplclr_version: $('#pnl_editapprovalform-txt_hremplclr_version'),
	chk_hremplclrappr_isdeclined: $('#pnl_editapprovalform-chk_hremplclrappr_isdeclined'),
	txt_hremplclrappr_declinedby: $('#pnl_editapprovalform-txt_hremplclrappr_declinedby'),
	txt_hremplclrappr_declineddate: $('#pnl_editapprovalform-txt_hremplclrappr_declineddate'),
	txt_hremplclrappr_notes: $('#pnl_editapprovalform-txt_hremplclrappr_notes'),
	txt_hremplclr_id: $('#pnl_editapprovalform-txt_hremplclr_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_hremplclrappr_id,
		autoid: true,
		logview: 'trn_hremplclrappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.hremplclr_id)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.hremplclr_id= hdata.hremplclr_id
...
function form_idsetup(options) {
	var objid = obj.txt_hremplclrappr_id
