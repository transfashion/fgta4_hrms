...
/**
 * hrms/hrd/hremplmutmodel/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header hremplmutmodel (mst_hremplmutmodel)
...
$API = new class extends hremplmutmodelBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.hremplmutmodel_id LIKE CONCAT('%', :search, '%') OR A.hremplmutmodel_name LIKE CONCAT('%', :search, '%') "
			];
