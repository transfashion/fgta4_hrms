...
import * as hnd from  './hremplmutmodel-edit-hnd.mjs'
...
const obj = {
	txt_hremplmutmodel_id: $('#pnl_edit-txt_hremplmutmodel_id'),
	txt_hremplmutmodel_name: $('#pnl_edit-txt_hremplmutmodel_name'),
	txt_hremplmutmodel_descr: $('#pnl_edit-txt_hremplmutmodel_descr'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_hremplmutmodel_id,
		autoid: false,
		logview: 'mst_hremplmutmodel',
...
function form_idsetup(options) {
	var objid = obj.txt_hremplmutmodel_id
