...
if (is_file(__DIR__ .'/hremplmutmodel.php-handler.php')) {
	require_once __DIR__ .'/hremplmutmodel.php-handler.php';
}

/**
 * hrms/hrd/hremplmutmodel/hremplmutmodel.php
 *
 * ===================================================================
 * Entry point Program Module hremplmutmodel
 * ===================================================================
 ...
 * awal dibuat tanggal 04/02/2023
 * terakhir di generate tanggal 04/02/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hremplmutmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hremplmutmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
