...
const obj = {
	txt_hremplmutappr_id: $('#pnl_editapprovalform-txt_hremplmutappr_id'),
	chk_hremplmutappr_isapproved: $('#pnl_editapprovalform-chk_hremplmutappr_isapproved'),
	txt_hremplmutappr_by: $('#pnl_editapprovalform-txt_hremplmutappr_by'),
	txt_hremplmutappr_date: $('#pnl_editapprovalform-txt_hremplmutappr_date'),
	txt_hremplmut_version: $('#pnl_editapprovalform-txt_hremplmut_version'),
	chk_hremplmutappr_isdeclined: $('#pnl_editapprovalform-chk_hremplmutappr_isdeclined'),
	txt_hremplmutappr_declinedby: $('#pnl_editapprovalform-txt_hremplmutappr_declinedby'),
	txt_hremplmutappr_declineddate: $('#pnl_editapprovalform-txt_hremplmutappr_declineddate'),
	txt_hremplmutappr_notes: $('#pnl_editapprovalform-txt_hremplmutappr_notes'),
	txt_hremplmut_id: $('#pnl_editapprovalform-txt_hremplmut_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_hremplmutappr_id,
		autoid: true,
		logview: 'trn_hremplmutappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.hremplmut_id)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.hremplmut_id= hdata.hremplmut_id
...
function form_idsetup(options) {
	var objid = obj.txt_hremplmutappr_id
