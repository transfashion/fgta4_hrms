...
if (is_file(__DIR__ .'/hremplmut.php-handler.php')) {
	require_once __DIR__ .'/hremplmut.php-handler.php';
}

/**
 * hrms/hrd/hremplmut/hremplmut.php
 *
 * ===================================================================
 * Entry point Program Module hremplmut
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hremplmut_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hremplmut_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
