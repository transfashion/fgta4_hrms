...
if (is_file(__DIR__ .'/empl.php-handler.php')) {
	require_once __DIR__ .'/empl.php-handler.php';
}

/**
 * hrms/master/empl/empl.php
 *
 * ===================================================================
 * Entry point Program Module empl
 * ===================================================================
 ...
 * terakhir di generate tanggal 20/01/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\empl_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new empl_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
