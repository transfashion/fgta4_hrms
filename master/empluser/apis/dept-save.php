...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_empldept';
		$primarykey = 'empldept_id';
		...
		try {
			...
			$obj->empldept_id = strtoupper($obj->empldept_id);
			...
			try {
				...
				$header_table = 'mst_empluser';
				$header_primarykey = 'empl_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'empldept_id', 'dept_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
