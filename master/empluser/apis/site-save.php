...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_emplsite';
		$primarykey = 'emplsite_id';
		...
		try {
			...
			$obj->emplsite_id = strtoupper($obj->emplsite_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'emplsite_id', 'site_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
