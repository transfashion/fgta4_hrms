	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"empldept_id" => " empldept_id = :empldept_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_empldept', [
				'empldept_id', 'dept_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
