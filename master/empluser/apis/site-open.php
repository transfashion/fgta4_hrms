	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"emplsite_id" => " emplsite_id = :emplsite_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_emplsite', [
				'emplsite_id', 'site_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
