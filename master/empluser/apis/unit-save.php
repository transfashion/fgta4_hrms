...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_emplunit';
		$primarykey = 'emplunit_id';
		...
		try {
			...
			$obj->emplunit_id = strtoupper($obj->emplunit_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'emplunit_id', 'unit_id', 'empl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
