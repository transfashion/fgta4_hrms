...
const obj = {
	txt_empldept_id: $('#pnl_editdeptform-txt_empldept_id'),
	cbo_dept_id: $('#pnl_editdeptform-cbo_dept_id'),
	txt_empl_id: $('#pnl_editdeptform-txt_empl_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_empldept_id,
		autoid: true,
		logview: 'mst_empldept',
		btn_edit: btn_edit,
		btn_save: btn_save,
