...
if (is_file(__DIR__ .'/hrstatus.php-handler.php')) {
	require_once __DIR__ .'/hrstatus.php-handler.php';
}

/**
 * hrms/master/hrstatus/hrstatus.php
 *
 * ===================================================================
 * Entry point Program Module hrstatus
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hrstatus_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hrstatus_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
