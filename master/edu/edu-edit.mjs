...
import * as hnd from  './edu-edit-hnd.mjs'
...
const obj = {
	txt_edu_id: $('#pnl_edit-txt_edu_id'),
	txt_edu_name: $('#pnl_edit-txt_edu_name'),
	txt_edu_descr: $('#pnl_edit-txt_edu_descr')
}
