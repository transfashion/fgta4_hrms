 ...
 * kelas ini harus di-inherit untuk semua api pada modul edu
 *
...
class eduBase extends WebAPI {
	...
	protected $main_tablename = "mst_edu";
	protected $main_primarykey = "edu_id";
	protected $main_field_version = "edu_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*edu*/.txt";
		// debug::disable();
