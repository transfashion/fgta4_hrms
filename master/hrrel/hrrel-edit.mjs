...
import * as hnd from  './hrrel-edit-hnd.mjs'
...
const obj = {
	txt_hrrel_id: $('#pnl_edit-txt_hrrel_id'),
	txt_hrrel_name: $('#pnl_edit-txt_hrrel_name')
}
