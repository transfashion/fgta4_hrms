...
/**
 * hrms/master/hrrel/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header hrrel (mst_hrrel)
...
$API = new class extends hrrelBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.hrrel_id LIKE CONCAT('%', :search, '%') OR A.hrrel_name LIKE CONCAT('%', :search, '%') "
			];
