...
if (is_file(__DIR__ .'/hrrel.php-handler.php')) {
	require_once __DIR__ .'/hrrel.php-handler.php';
}

/**
 * hrms/master/hrrel/hrrel.php
 *
 * ===================================================================
 * Entry point Program Module hrrel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hrrel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hrrel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
