...
/**
 * hrms/master/team/apis/member-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel member team (mst_team)
 *
...
$API = new class extends teamBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_teamempl';
		$primarykey = 'teamempl_id';
		...
		try {
			...
			$obj->team_id = strtoupper($obj->team_id);
			...
			try {
				...
				$header_table = 'mst_team';
				$header_primarykey = 'team_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'teamempl_id', 'empl_id', 'team_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
