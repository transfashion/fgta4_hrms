...
const obj = {
	txt_team_id: $('#pnl_edit-txt_team_id'),
	txt_team_name: $('#pnl_edit-txt_team_name'),
	txt_team_descr: $('#pnl_edit-txt_team_descr'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	chk_team_isdisabled: $('#pnl_edit-chk_team_isdisabled')
}
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editmembergrid'].handler.createnew(data, options)
