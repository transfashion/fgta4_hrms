...
/**
 * hrms/master/contract/apis/xapi.base.php
 *
 * contractBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul contract
 *
 ...
 * tanggal 17/03/2023
 */
class contractBase extends WebAPI {

	protected $main_tablename = "mst_hrcont";
	protected $main_primarykey = "hrcont_id";
	protected $main_field_version = "hrcont_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*contract*/.txt";
		// debug::disable();
