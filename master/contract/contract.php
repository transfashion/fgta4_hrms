...
if (is_file(__DIR__ .'/contract.php-handler.php')) {
	require_once __DIR__ .'/contract.php-handler.php';
}

/**
 * hrms/master/contract/contract.php
 *
 * ===================================================================
 * Entry point Program Module contract
 * ===================================================================
 ...
 * awal dibuat tanggal 17/03/2023
 * terakhir di generate tanggal 17/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\contract_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new contract_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
