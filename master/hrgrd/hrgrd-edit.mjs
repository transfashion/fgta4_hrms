...
import * as hnd from  './hrgrd-edit-hnd.mjs'
...
const obj = {
	txt_hrgrd_id: $('#pnl_edit-txt_hrgrd_id'),
	txt_hrgrd_name: $('#pnl_edit-txt_hrgrd_name'),
	txt_hrgrd_group: $('#pnl_edit-txt_hrgrd_group'),
	txt_hrgrd_descr: $('#pnl_edit-txt_hrgrd_descr'),
	txt_hrgrd_order: $('#pnl_edit-txt_hrgrd_order'),
