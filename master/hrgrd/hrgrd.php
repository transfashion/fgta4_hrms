...
if (is_file(__DIR__ .'/hrgrd.php-handler.php')) {
	require_once __DIR__ .'/hrgrd.php-handler.php';
}

/**
 * hrms/master/hrgrd/hrgrd.php
 *
 * ===================================================================
 * Entry point Program Module hrgrd
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hrgrd_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hrgrd_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
