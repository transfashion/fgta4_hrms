...
if (is_file(__DIR__ .'/hrjob.php-handler.php')) {
	require_once __DIR__ .'/hrjob.php-handler.php';
}

/**
 * hrms/master/hrjob/hrjob.php
 *
 * ===================================================================
 * Entry point Program Module hrjob
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hrjob_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hrjob_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
