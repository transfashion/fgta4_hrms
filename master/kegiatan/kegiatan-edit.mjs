...
import * as hnd from  './kegiatan-edit-hnd.mjs'
...
const obj = {
	txt_kegiatan_id: $('#pnl_edit-txt_kegiatan_id'),
	dt_kegiatan_date: $('#pnl_edit-dt_kegiatan_date'),
	txt_kegiatan_descr: $('#pnl_edit-txt_kegiatan_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_kegiatan_id,
		autoid: true,
		logview: 'mst_kegaitan',
