...
const obj = {
	txt_marital_id: $('#pnl_edit-txt_marital_id'),
	txt_marital_name: $('#pnl_edit-txt_marital_name'),
	txt_marital_descr: $('#pnl_edit-txt_marital_descr'),
	txt_marital_ptkpval: $('#pnl_edit-txt_marital_ptkpval')
}
