...
if (is_file(__DIR__ .'/candidate.php-handler.php')) {
	require_once __DIR__ .'/candidate.php-handler.php';
}

/**
 * hrms/recruit/candidate/candidate.php
 *
 * ===================================================================
 * Entry point Program Module candidate
 * ===================================================================
 ...
 * awal dibuat tanggal 25/02/2023
 * terakhir di generate tanggal 25/02/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\candidate_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new candidate_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
