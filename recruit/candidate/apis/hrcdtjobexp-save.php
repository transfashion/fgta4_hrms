...
/**
 * hrms/recruit/candidate/apis/hrcdtjobexp-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends candidateBase {
	...
	public function execute($data, $options, $files) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new candidate_hrcdtjobexpHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$obj->hrcdtjobexp_dtjoin = (\DateTime::createFromFormat('d/m/Y',$obj->hrcdtjobexp_dtjoin))->format('Y-m-d');
			$obj->hrcdtjobexp_dtleave = (\DateTime::createFromFormat('d/m/Y',$obj->hrcdtjobexp_dtleave))->format('Y-m-d');

			$obj->hrcdtjobexp_company = strtoupper($obj->hrcdtjobexp_company);
			$obj->hrcdtjobexp_position = strtoupper($obj->hrcdtjobexp_position);
			...
			try {
				...
				// result
				$options->criteria = [
					"hrcdtjobexp_id" => $obj->hrcdtjobexp_id
				];
				...
				$dataresponse = array_merge($record, [
					...
					'hrcdtjobexp_dtjoin' => date("d/m/Y", strtotime($row['hrcdtjobexp_dtjoin'])),
					'hrcdtjobexp_dtleave' => date("d/m/Y", strtotime($row['hrcdtjobexp_dtleave'])),
