...
/**
 * hrms/recruit/candidate/apis/xapi.base.php
 *
 * candidateBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul candidate
 *
 ...
 * tanggal 25/02/2023
 */
class candidateBase extends WebAPI {

	protected $main_tablename = "mst_hrcdt";
	protected $main_primarykey = "hrcdt_id";
	protected $main_field_version = "hrcdt_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*candidate*/.txt";
		// debug::disable();
