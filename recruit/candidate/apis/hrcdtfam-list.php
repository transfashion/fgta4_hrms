...
/**
 * hrms/recruit/candidate/apis/hrcdtfam-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel hrcdtfam candidate (mst_hrcdtfam)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('hrrel_name', 'hrrel_id', $record, 'mst_hrrel', 'hrrel_name', 'hrrel_id');
