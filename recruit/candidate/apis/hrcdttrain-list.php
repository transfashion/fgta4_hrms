...
/**
 * hrms/recruit/candidate/apis/hrcdttrain-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel hrcdttrain candidate (mst_hrcdttrain)
...
$API = new class extends candidateBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new candidate_hrcdttrainHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
