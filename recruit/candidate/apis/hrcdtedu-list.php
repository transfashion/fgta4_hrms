...
/**
 * hrms/recruit/candidate/apis/hrcdtedu-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel hrcdtedu candidate (mst_hrcdtedu)
...
$API = new class extends candidateBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new candidate_hrcdteduHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
