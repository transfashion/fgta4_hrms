...
/**
 * hrms/recruit/candidate/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header candidate (mst_hrcdt)
...
$API = new class extends candidateBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.hrcdt_name LIKE CONCAT('%', :search, '%') OR A.hrcdt_email LIKE CONCAT('%', :search, '%') OR A.hrcdt_handphone LIKE CONCAT('%', :search, '%') OR A.hrcdt_ktp LIKE CONCAT('%', :search, '%') "
			];
