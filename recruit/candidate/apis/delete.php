...
/**
 * hrms/recruit/candidate/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header candidate (mst_hrcdt)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_hrcdtedu', 'mst_hrcdtfam', 'mst_hrcdttrain', 'mst_hrcdtjobexp', 'mst_hrcdtorg', 'mst_hrcdtreff', 'mst_hrcdtattch'];
